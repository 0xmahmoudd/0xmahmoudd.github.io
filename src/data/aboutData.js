...
I strive to be a T-shaped engineer by combining deep backend systems knowledge (database internal optimization, AST validation, Clean Architecture, query tuning) with modern frontend craftsmanship (React, responsive design, interactive UIs). Currently preparing for the AWS Certified Solutions Architect – Associate (SAA-C03) certification and actively contributing to open-source database monitoring tools like pgwatch.`,
  education: {
    ...
    degree: "B.Sc. in Computer Science, Faculty of Computers and Artificial Intelligence",
    ...
    coursework: [
      ...
      "Database Internals & SQL Tuning",
      "Computer Networks & Protocols",
      "Artificial Intelligence & Machine Learning",
      "Compiler Construction & AST Parsing"
    ]
  },
  highlights: [
    { title: "300+ Problems Solved", desc: "Algorithmic mastery across LeetCode, NeetCode & Codeforces" },
    { title: "98.4% Latency Reduction", desc: "Optimized REST API database queries with pushed LIMIT/OFFSET & EF Core projections" },
    { title: "AWS Solutions Architect", desc: "Preparing for AWS SAA-C03, built enterprise multi-AZ cloud architecture blueprints" },
    { title: "Open Source Contributor", desc: "Built pgwatch Copilot Go CLI for PostgreSQL monitoring with AST parsing & safety checks" }
  ]
};
